...
class MarketplaceSeedCatalog {
  ...
  static final List<ProjectSummary> customerProjects = [
    ...
    ProjectSummary(
      ...
      responsesCount: 2, // совпадает с числом реальных откликов ниже
      workType: 'Сантехника',
      budget: '45 000 ₽',
      address: 'Москва, ЗАО, Кунцево',
      spec:
  ...
  static final List<OrderFeedItem> orderFeed = [
    ...
    const OrderFeedItem(
      // id совпадает с проектом p2 — мастер и заказчик видят один заказ
      // под одним названием «Санузел под ключ».
      id: 'p2',
      workType: 'Санузел под ключ',
